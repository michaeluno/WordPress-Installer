...
downloadWPCLI() {
  ...
  if [ "$2" = "latest" ]; then
    ...
    download "https://github.com/wp-cli/wp-cli/releases/download/v$2/wp-cli-$2.phar" "$1"
  fi
    ...
    # 2.5.0
    # download https://github.com/wp-cli/wp-cli/releases/download/v2.5.0/wp-cli-2.5.0.phar
